...
export class ListEmployeesComponent {
  ...
  constructor(
    ...
    private _deActivateDialog : MatDialog,
...
*/
  ...
  deleteUserDialog(idEmployee: number) {
    ...
    this._employeesService.getEmployeeDetails().subscribe(
      (employees: EmployeesModel[]) => {
        ...
        if (employee) {
          ...
          Swal.fire({
            title: '¿Estás seguro?',
            html: `Esta acción eliminará al empleado ${fullName}. ¿Estás seguro que deseas continuar?`,
            icon: 'warning',
      ...
      this._employeesService.getEmployeeDetails().subscribe(
        (employees: EmployeesModel[]) => {
          ...
          if (employee) {
            ...
            Swal.fire({
              title: '¿Estás seguro?',
              html: `Esta acción dará de baja al empleado ${fullName}. ¿Estás seguro que deseas continuar?`,
              icon: 'warning',
              showCancelButton: true,
